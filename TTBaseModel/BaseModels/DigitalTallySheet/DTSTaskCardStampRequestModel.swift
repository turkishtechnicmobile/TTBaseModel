...
public enum StampStatus: Int, Encodable {
    ...
    public static func withString(_ value: String) -> StampStatus? {
        ...
        case "CANCEL" : return .CUSTOMERAWAITING
        case "CANCEL APPROVED" : return .CUSTOMERAPPROVED
        case "CANCEL REJECTED" : return .CUSTOMERREJECTED
        default: return nil
        }
