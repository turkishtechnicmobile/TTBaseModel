...
open class BaseFirstViewModel: ViewModel {
    ...
    public var state: Dynamic<TableViewState> = Dynamic(.loading)
    public private(set) var errorState: Dynamic<ErrorState> = Dynamic(.idle)
...
open class BaseFirstListViewModel<T: ItemViewModel>: BaseFirstViewModel, ListViewModel {
    ...
    public private(set) var selectRows: Dynamic<[IndexPath]> = Dynamic([IndexPath]())
    public private(set) var reloadRows: Dynamic<[IndexPath]> = Dynamic([IndexPath]())
    public private(set) var deleteRows: Dynamic<[IndexPath]> = Dynamic([IndexPath]())
